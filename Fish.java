public class Fish extends Animal {
    ...
    public Fish(String name, int age, String type, String condition, String owner, boolean needsAppointment, String appointmentDate) {
        super(name, age, type, condition, owner, needsAppointment, appointmentDate);
    }

    public Fish(String name, int age, String type, String condition, String owner) {
